...
withEventDeliveryModes(
  ...
  async ({ page }) => {
    ...
    await page
      ...
      .last()
      .fill(
        "Create a custom component that can generate a random number between 1 and 100 and is called Axie Studio Random Number",
      );
    ...
    expect(textContents.toLowerCase()).toContain("axiestudio");
  },
);
