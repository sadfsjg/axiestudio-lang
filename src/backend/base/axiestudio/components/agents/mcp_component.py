...
from axiestudio.api.v2.mcp import get_server
from axiestudio.base.agents.utils import maybe_unflatten_dict, safe_cache_get, safe_cache_set
from axiestudio.base.mcp.util import (
    MCPSseClient,
    MCPStdioClient,
...
from axiestudio.inputs.inputs import InputTypes  # noqa: TC001
from axiestudio.io import DropdownInput, McpInput, MessageTextInput, Output
from axiestudio.io.schema import flatten_schema, schema_to_axiestudio_inputs
...
class MCPToolsComponent(ComponentWithCache):
    ...
    async def _validate_schema_inputs(self, tool_obj) -> list[InputTypes]:
        ...
        try:
            ...
            schema_inputs = schema_to_axiestudio_inputs(input_schema)
    ...
    def get_inputs_for_all_tools(self, tools: list) -> dict:
        ...
        for tool in tools:
            ...
            try:
                ...
                input_schema = create_input_schema_from_json_schema(flat_schema)
                axiestudio_inputs = schema_to_axiestudio_inputs(input_schema)
                inputs[tool.name] = axiestudio_inputs
    ...
    async def build_output(self) -> DataFrame:
        ...
        try:
            ...
            if self.tool != "":
                # Set session context for persistent MCP sessions using Axie Studio session ID
    ...
    def _get_session_context(self) -> str | None:
        """Get the Axie Studio session ID for MCP session caching."""
