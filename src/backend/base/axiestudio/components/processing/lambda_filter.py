...
from axiestudio.io import DataInput, HandleInput, IntInput, MultilineInput, Output
from axiestudio.schema.data import Data
from axiestudio.utils.data_structure import get_data_structure
...
class LambdaFilterComponent(Component):
    ...
    documentation: str = "https://docs.axiestudio.org/components-processing#smart-function"
