...
from axiestudio.io import DictInput, IntInput, SecretStrInput, StrInput, TableInput
...
class AstraDBCQLToolComponent(LCToolComponent):
    ...
    documentation: str = "https://docs.axiestudio.org/Components/components-tools#astra-db-cql-tool"
    icon: str = "AstraDB"
