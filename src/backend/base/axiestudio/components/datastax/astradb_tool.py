...
from axiestudio.io import BoolInput, DictInput, HandleInput, IntInput, SecretStrInput, StrInput, TableInput
...
class AstraDBToolComponent(LCToolComponent):
    ...
    documentation: str = "https://docs.axiestudio.org/components-bundle-components"
    icon: str = "AstraDB"
