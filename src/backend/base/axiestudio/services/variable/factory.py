...
from axiestudio.services.variable.service import DatabaseVariableService, VariableService
...
class VariableServiceFactory(ServiceFactory):
    ...
    def create(self, settings_service: SettingsService):
        ...
        if settings_service.settings.variable_store == "kubernetes":
            ...
            from axiestudio.services.variable.kubernetes import KubernetesSecretService
