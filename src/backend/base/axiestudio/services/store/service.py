...
from axiestudio.services.store.exceptions import APIKeyError, FilterError, ForbiddenError
...
from axiestudio.services.store.utils import (
...
def get_id_from_search_string(search_string: str) -> str | None:
    ...
    if "www.axiestudio.store/store/" in search_string:
