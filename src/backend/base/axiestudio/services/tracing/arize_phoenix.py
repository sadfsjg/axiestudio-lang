...
class ArizePhoenixTracer(BaseTracer):
    ...
    def __init__(
        ...
        try:
            ...
            self.root_span.set_attribute("axiestudio.project.name", self.project_name)
            self.root_span.set_attribute("axiestudio.flow.name", self.flow_name)
            self.root_span.set_attribute("axiestudio.flow.id", self.flow_id)
