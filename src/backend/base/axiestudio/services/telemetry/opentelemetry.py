...
axiestudio_meter_name = "axiestudio"
...
class ObservableGaugeWrapper:
    ...
    def __init__(self, name: str, description: str, unit: str):
        ...
        self._meter = metrics.get_meter(axiestudio_meter_name)
    ...
    def __init__(self, *, prometheus_enabled: bool = True):
        ...
        if self._meter_provider is None:
            ...
            if hasattr(existing_provider, "get_meter") and existing_provider.get_meter("http.server"):
                ...
                resource = Resource.create({"service.name": "axiestudio"})
                metric_readers = []
        ...
        self.meter = self._meter_provider.get_meter(axiestudio_meter_name)
