...
from axiestudio.services.telemetry.schema import (
    ComponentPayload,
    PlaygroundPayload,
    RunPayload,
    ShutdownPayload,
...
class TelemetryService(Service):
    ...
    def _get_axiestudio_desktop(self) -> bool:
        # Coerce to bool, could be 1, 0, True, False, "1", "0", "True", "False"
        return str(os.getenv("AXIESTUDIO_DESKTOP", "False")).lower() in {"1", "true"}
    ...
    async def log_package_version(self) -> None:
        ...
        payload = VersionPayload(
            ...
            desktop=self._get_axiestudio_desktop(),
        )
