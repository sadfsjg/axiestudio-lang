...
from axiestudio.services.database.models.flow.model import FlowBase
...
def upload(file_path: str, host: str, flow_id: str):
    """Upload a file to Axie Studio and return the file path.

    Args:
        file_path (str): The path to the file to be uploaded.
        host (str): The host URL of Axie Studio.
...
def upload_file(file_path: str, host: str, flow_id: str, components: list[str], tweaks: dict | None = None):
    ...
    Args:
        file_path (str): The path to the file to be uploaded.
        host (str): The host URL of Axie Studio.
        port (int): The port number of Axie Studio.
        flow_id (UUID): The ID of the flow to which the file belongs.
...
def get_flow(url: str, flow_id: str):
    """Get the details of a flow from Axie Studio.

    Args:
        url (str): The host URL of Axie Studio.
        port (int): The port number of Axie Studio.
