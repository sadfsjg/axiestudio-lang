...
from axiestudio.graph.schema import CHAT_COMPONENTS
from axiestudio.utils.lazy_load import LazyLoadDictBase

if TYPE_CHECKING:
    from axiestudio.graph.vertex.base import Vertex
    from axiestudio.graph.vertex.vertex_types import CustomComponentVertex
...
def _import_vertex_types():
    from axiestudio.graph.vertex import vertex_types
