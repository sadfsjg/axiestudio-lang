...
from axiestudio.serialization.serialization import get_max_items_length, get_max_text_length, serialize
from axiestudio.services.database.models.transactions.crud import log_transaction as crud_log_transaction
from axiestudio.services.database.models.transactions.model import TransactionBase
from axiestudio.services.database.models.vertex_builds.crud import log_vertex_build as crud_log_vertex_build
from axiestudio.services.database.models.vertex_builds.model import VertexBuildBase
...
if TYPE_CHECKING:
    from axiestudio.api.v1.schemas import ResultDataResponse
...
def has_chat_output(vertices: dict[Vertex, int]):
    from axiestudio.graph.schema import InterfaceComponentTypes
