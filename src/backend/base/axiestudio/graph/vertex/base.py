...
from axiestudio.graph.utils import UnbuiltObject, UnbuiltResult, log_transaction
from axiestudio.graph.vertex.param_handler import ParameterHandler
from axiestudio.interface import initialize
from axiestudio.interface.listing import lazy_load_dict
from axiestudio.schema.artifact import ArtifactType
from axiestudio.schema.data import Data
from axiestudio.schema.message import Message
from axiestudio.schema.schema import INPUT_FIELD_NAME, OutputValue, build_output_logs
from axiestudio.services.deps import get_storage_service
from axiestudio.utils.schemas import ChatOutputResponse
from axiestudio.utils.util import sync_to_async
...
class Vertex:
    ...
    async def build(
        ...
        **kwargs,
        ...
        from axiestudio.interface.components import ensure_component_loaded
