...
from axiestudio.inputs.validators import CoalesceBool
from axiestudio.schema.data import Data
from axiestudio.schema.message import Message
from axiestudio.services.database.models.message.model import MessageBase
    ...
    def validate_value(cls, v: Any, _info):
        ...
        if not isinstance(v, list):
            msg = (
                ...
                "- A Data object (Axie Studio's internal data structure)\n"
            )
        ...
        for i, item in enumerate(v):
            if not isinstance(item, dict | Data):
                msg = (
                    ...
                    "- A Data object (Axie Studio's internal data structure for passing data between components)\n"
...
class MessageTextInput(StrInput, MetadataTraceMixin, InputTraceMixin, ToolModeMixin):
    """Represents a text input component for the Axie Studio system.

    This component is used to handle text inputs in the Axie Studio system.
