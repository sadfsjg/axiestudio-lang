...
class DataFrame(pandas_DataFrame):
    ...
    Axie Studio's Data objects and pandas' powerful data manipulation capabilities.
    ...
    def to_message(self) -> Message:
        from axiestudio.schema.message import Message  # Local import to avoid circular import
