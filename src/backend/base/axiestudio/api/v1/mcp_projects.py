...
from axiestudio.api.utils import CurrentActiveMCPUser
from axiestudio.api.v1.mcp_utils import (
    current_user_ctx,
    handle_call_tool,
...
from axiestudio.base.mcp.constants import MAX_MCP_SERVER_NAME_LENGTH
from axiestudio.base.mcp.util import sanitize_mcp_name
from axiestudio.services.database.models import Flow, Folder
from axiestudio.services.deps import get_settings_service, session_scope
from axiestudio.services.settings.feature_flags import FEATURE_FLAGS
    ...
    try:
        async with session_scope() as session:
            ...
            if project.auth_settings:
                from axiestudio.api.v1.schemas import AuthSettings
...
class ProjectMCPServer:
    def __init__(self, project_id: UUID):
        ...
        self.server = Server(f"axiestudio-mcp-project-{project_id}")
