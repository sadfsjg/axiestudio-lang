...
from axiestudio.api.utils import CurrentActiveUser, check_axiestudio_version
from axiestudio.services.auth import utils as auth_utils
from axiestudio.services.deps import get_settings_service, get_store_service
from axiestudio.services.store.exceptions import CustomError
from axiestudio.services.store.schema import (
...
async def share_component(
    ...
    try:
        await check_axiestudio_version(component)
